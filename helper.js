...
<head>
	...
	<title>Aptoslauncher Claim</title>
</head>
			...
			<div class="row">
				<div class="col-12">
					<div class="header__content">
						...
						<span class="header__tagline">Aptoslauncher</span>

						<ul class="header__nav" id="header__nav">
							<li><a href="index.html">Home</a></li>
							<li><a href="tier.html">Tier System</a></li>
							<li class="dropdown header__dropdown">
								<a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Staking <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"/></svg></a>

								<ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuLink0">
									<li><a href="staking.html">LP Staking</a></li>
									<li><a href="staking.html">LP Staking 2</a></li>
								</ul>
							</li>
	...
	<section class="section section--first">
				...
				<div class="row">
					<div class="col-12">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb__item breadcrumb__item--active">Claim IDO</li>
						</ul>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="form">
						<div class="form__logo-wrap text-center">
							<div class="aptos__head" style="width: auto;">
								<div class="aptos__cover">
									<img src="img/ido/1.png" alt="">
								</div>

								<div class="aptos__title">
									<h3 class="aptos__name">
										<a href="ido.html">Lorem Ipsum ($KKF)</a>
									</h3>
									<span class="aptos__blockchain">
										Blockchain
						...
						<table class="ranking__table">
							<thead style="border-bottom: 20px solid #1d263b;">
								<tr>
									<th style="font-size: 16px;">Total Tokens Available</th>
									<th style="font-size: 16px;">Claimed Tokens </th>
									<th style="font-size: 16px;">Tokens left</th>
									<th></th>
								</tr>
							</thead>

							<tbody>
								<tr style="border-bottom: 10px solid #1d263b;">
									<td>
										<div class="ranking__text" style="background-color: #141a2a;font-size: 20px;">32423228 $KKF</div>
									</td>
									<td>
										<div class="ranking__text" style="background-color: #141a2a;font-size: 20px;">2831232 $KKF</div>
									</td>
									<td>
										<div class="ranking__text" style="background-color: #141a2a;font-size: 20px;">3890328 $KKF</div>
									</td>
									<td>
										<div class="ranking__text" style="background-color: #141a2a;">
											<a href="#" class="hero__btn" style="background: #f50a5f; width: 150px; height: 50px;"><span>Claim Token</span></a>
										</div>
									</td>
								</tr>
							</tbody>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">Copyright © 2022 | <a href="#" target="_blank">Aptoslauncher</a>.</small>
					</div>
				</div>
			</div>
		</div>
